...
int main()
{
	...
	for (int i = 0; i < sizeof(vertices) / (6 * sizeof(float)); ++i)
	{
		for (int j = 0; j < 6; ++j)
		{
			...
			{
			case 0:
				tmp_vertice.Position.x = vertices[6 * i + j];
				break;
			case 1:
				tmp_vertice.Position.y = vertices[6 * i + j];
				break;
			case 2:
				tmp_vertice.Position.z = vertices[6 * i + j];
				break;
			case 3:
				tmp_vertice.Normal.x = vertices[6 * i + j];
				break;
			case 4:
				tmp_vertice.Normal.y = vertices[6 * i + j];
				break;
			case 5:
				tmp_vertice.Normal.z = vertices[6 * i + j];
				break;
			default:
				break;
			}
